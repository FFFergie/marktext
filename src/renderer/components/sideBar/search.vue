    ...
    >
      <div class="search-wrapper">
        <input
          ...
          :placeholder="$t('search.searchInFolderPlaceholder')"
          @keyup="search"
        >
        <div class="controls">
          <span
...
export default {
  ...
  computed: {
    ...
    searchResultInfo () {
      ...
      return this.$t('search.resultInfo', { matchCount, fileCount })
    },
      ...
      const promises = ripgrepDirectorySearcher.search([rootDirectoryPath], keyword, {
        ...
        didSearchPaths: numPathsFound => {
          ...
          if (!canceled && numPathsFound > 100) {
            ...
            this.searchErrorString = this.$t('search.limitToHundredFiles')
          }
        },
