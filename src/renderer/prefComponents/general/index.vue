<template>
  <div class="pref-general">
    ...
    <compound>
      ...
      <template #children>
        <bool
          :description="$t('pref.general.autoSave.autoSaveChanges')"
          :bool="autoSave"
    ...
    <compound>
      ...
      <template #children>
        ...
        ></cur-select>
        <bool
          :description="$t('pref.general.window.hideScrollbars')"
          :bool="hideScrollbar"
    ...
    <compound>
      ...
      <template #children>
        <bool
          :description="$t('pref.general.sidebar.wrapTextInToc')"
          :bool="wordWrapInToc"
      ...
      <template #children>
        <section class="startup-action-ctrl">
          <el-radio-group v-model="startUpAction">
            ...
            -->
            <el-radio label="folder" style="margin-bottom: 10px;">{{ $t('pref.general.startup.openDefaultDirectory') }}<span>: {{defaultDirectoryToOpen}}</span></el-radio>
            <el-button size="small" @click="selectDefaultDirectoryToOpen">{{ $t('common.selectFolder') }}</el-button>
            <el-radio label="blank">{{ $t('pref.general.startup.openBlankPage') }}</el-radio>
          </el-radio-group>
        </section>
      </template>
    </compound>
    ...
    <compound>
      ...
      <template #children>
        <cur-select
          :description="$t('pref.general.misc.userInterfaceLanguage')"
          :value="language"
